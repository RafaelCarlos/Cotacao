...
import com.example.conversor.model.Bovespa;
import com.example.conversor.model.Cotacoes;
import com.example.conversor.model.Dolar;
import com.example.conversor.model.Euro;
...
/**
 * Created by rafaelcarlos on 11/02/16.
 */
...
//        buscaDados.execute("http://developers.agenciaideias.com.br/cotacoes/json");
        ...
        if (FabricaNet.isNetworkAvailable(this)) {
            new BuscaDadoss(this).execute("http://developers.agenciaideias.com.br/cotacoes/xml");
...
//            Toast.makeText(this, "Por favor, verifique sua conexão de internet!", Toast.LENGTH_LONG).show();
        ...
        ivInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ActivityXml.this, TelaSobreActivity.class));
            }
        });
        ...
        tvChamaTelaDolarTurismo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ActivityXml.this, TelaPrincipal.class));
            }
        });
    }
}

class BuscaDadoss extends AsyncTask<String, Void, Cotacoes> {
    ...
    public BuscaDadoss(Activity activity) {
